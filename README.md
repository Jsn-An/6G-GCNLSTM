...
- [2. Quick Navigation (for different readers)](#2-quick-navigation-for-different-readers)
- [3. Project Structure & File Index](#3-project-structure--file-index)
  - [3.1 Dataset](#31-dataset)
  - [3.2 Data Processing & Graph Construction](#32-data-processing--graph-construction)
  - [3.3 Prediction Model (GCN+LSTM)](#33-prediction-model-gcnlstm)
  - [3.4 Model Evaluation](#34-model-evaluation)
  - [3.5 Task Offloading Optimization](#35-task-offloading-optimization)
  - [3.6 Intelligent Scheduling](#36-intelligent-scheduling)
  - [3.7 Visualization Results](#37-visualization-results)
- [4. Complete Experiment Pipeline](#4-complete-experiment-pipeline)
- [5. Results Summary](#5-results-summary)
- [6. Setup & Run Guide](#6-setup--run-guide)
- [7. Technical Methods in Detail](#7-technical-methods-in-detail)
...
## 2. Quick Navigation (for different readers)

### 🔍 For Non-Technical Readers / Managers

Want a quick overview of what the project does and how well it performs?

| You want to know... | Go to... |
|---|---|
| What is this project about? | [1. Overview](#1-overview) |
| What is the experiment pipeline? | [4. Complete Experiment Pipeline](#4-complete-experiment-pipeline) |
| What are the final results? | [5. Results Summary](#5-results-summary) |
| What visualizations are available? | [3.7 Visualization Results](#37-visualization-results) |

### 🔧 For Technical Peers

Want to reproduce experiments or understand technical details?

| You want to know... | Go to... |
|---|---|
| How to install and run? | [6. Setup & Run Guide](#6-setup--run-guide) |
| How is the data processed? | [3.2 Data Processing & Graph Construction](#32-data-processing--graph-construction) |
| What does the model look like? | [3.3 Prediction Model](#33-prediction-model-gcnlstm) & [7. Technical Methods](#7-technical-methods-in-detail) |
| Where are all the code files? | [3. Project Structure & File Index](#3-project-structure--file-index) |
| How are offloading strategies implemented? | [3.5 Task Offloading Optimization](#35-task-offloading-optimization) |

### 📊 For Results Seekers

| You want to see... | Go to... |
|---|---|
| Prediction accuracy metrics | `results/metrics/per_node_metrics.csv` |
| Offloading strategy comparison | `results/metrics/offloading_strategy_comparison.csv` |
| Scheduling policy comparison | `results/metrics/scheduling_policy_comparison.csv` |
| All visualization figures | `reports/figures/` directory |

---

## 3. Project Structure & File Index
...
### 3.2 Data Processing & Graph Construction
...
### 3.5 Task Offloading Optimization
...
## 4. Complete Experiment Pipeline
...
### 5.1 Prediction Performance (GCN+LSTM vs Baselines)
...
### 5.2 Offloading Optimization Results
...
### 5.3 Scheduling Policy Comparison
...
pip install torch torch-geometric numpy pandas scipy matplotlib networkx scikit-learn
```
...
## 7. Technical Methods in Detail

### 7.1 Network Graph Modeling
...
### 7.2 GCN+LSTM Spatiotemporal Prediction
...
### 7.3 Prediction-Driven Task Offloading
